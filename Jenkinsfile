...
*/
        ...
        stage("Docker Build & Push"){
            steps{
                script{
                   withDockerRegistry(credentialsId: 'dckr_pat_9Yp8w3muiwrfiqQmjtl0w4w0VbY', toolName: 'docker', url: 'https://hub.docker.com/repository/docker/pascarusilviu/pet-clinic123/general') {
