...
*/
	  ...
	  stage("Build"){
		...
		stage("Docker Build & Push"){
            steps{
                script{
                   withDockerRegistry(credentialId: 'af6d220a-451a-4f0d-89dd-edfa88a5443b' toolName: 'docker', url: 'https://hub.docker.com/repository/docker/pascarusilviu/pet-clinic123/general') {
